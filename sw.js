const CACHE='mileage-tracker-v5.4.1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./company_template_data.js','./manifest.webmanifest','./icons/icon-192-v541.png','./icons/icon-512-v541.png'];

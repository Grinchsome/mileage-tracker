const CACHE='mileage-tracker-v5.2';
const ASSETS=['./','./index.html','./styles.css','./app.js','./company_template_data.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];

Mileage Tracker - Test Drive V5.6.3

WHAT IS NEW
- Driver Signature in Settings. Sign once with a finger/stylus, then preview, replace or clear it.
- V5.6.3 preserves the signature aspect ratio and positions it above the Driver Signature line.
...
- Keeps the V5.4 odometer and shortened-address export behaviour.
- Keeps the current tracked-van v3 app icons.

UPDATE
Upload all files over the files already in your mileage-tracker GitHub repository. Wait for GitHub Pages to deploy, then fully close and reopen the installed app. The header should show Test Drive v5.6.1.
...
V5.6.3 forces versioned JavaScript URLs so the installed PWA cannot show a new shell while using an older cached export script.
